...
(function(){
	...
	Tools.encrypt = function(context, key)
	{
		return cryptoJS.AES.encrypt(context, key).toString();
	}

	Tools.decrypt = function(context, key)
	{
		return cryptoJS.AES.decrypt(context, key).toString(cryptoJS.enc.Utf8);
	}
